...
# `communication` needs cupy and mpi4py and is only reached under
# distributed graph training (`partition` not None), which this vendoring
# never enables. Import it lazily so the model builds without either.
from ._compat import ExchangeNodes, exchange_nodes
